...
class Vector3 {
    ...
    static dot(other1, other2) {
        ...
        d = other1[0] * other2[0];
        d = d + other1[1] * other2[1];
        d = d + other1[2] * other2[2];
        // Don't delete the return statement.
        return d;
    }
    ...
    static cross(other1, other2) {
        ...
        let a = other1[1]*other2[2] - other1[2]*other2[1];
        let b = other1[2]*other2[0] - other1[0]*other2[2];
        let c = other1[0]*other2[1] - other1[1]*other2[0];
        v3[0] = a;
        v3[1] = b;
        v3[2] = c;
        // Don't delete the return statement.
